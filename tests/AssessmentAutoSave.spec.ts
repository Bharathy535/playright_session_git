...
test('Assessment Auto save using QTL', async ({ page }) => {
    ...
    await page.waitForLoadState('domcontentloaded');
      ...
      await page.locator(`//input[@name='identifier']`).fill('Bharathy.Munusamy@vca.com');
      await page.locator(`//input[@value='Next']`).press('Enter');
      await page.waitForLoadState('domcontentloaded');

      await page.locator(`//input[@type='password']`).isVisible({ timeout: 10000 });
      await page.locator(`//input[@type='password']`).fill('Divya@220811');
      ...
      await page.locator(`//input[@name ='credentials.answer']`).fill('Biriyani');
